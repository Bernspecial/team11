...
//         const itemCountElement = document.querySelector("#num-items");
//         subtotalElement.innerHTML = "$" + this.itemTotal.toFixed(2);
//         itemCountElement.innerHTML = this.list.length + " items";
//     }
...
//     displayOrderTotals() {
//         document.querySelector(this.outputSelector + " #shipping").innerHTML = "$" + this.shipping.toFixed(2);
